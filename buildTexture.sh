...
java -jar $TexturePacker  assets/shapes8bit img shapes8bit textureSettings.json
...
$Python atlasConvert.py img/shapes8bit_big.atlas > img/shapes8bit_big.json
$Python atlasConvert.py img/shapes8bit_small.atlas > img/shapes8bit_small.json
